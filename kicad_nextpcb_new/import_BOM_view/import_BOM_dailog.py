...
from kicad_nextpcb_new.import_BOM_view.import_BOM_store import ImportBOMStore
from kicad_nextpcb_new.part_selector_view.part_selector import PartSelectorDialog
from kicad_nextpcb_new.events import EVT_ASSIGN_PARTS_EVENT
from kicad_nextpcb_new.button_id import (ID_MANUAL_MATCH, ID_REMOVE_PART, 
                                        ID_COPY_MPN, ID_PASTE_MPN)
...
class ImportBOMDailog ( wx.Dialog ):
    ...
    def __init__( self, parent ):
        wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, 
                            title = u"Match Native BOM Table", pos = wx.DefaultPosition, 
        ...
        self.Bind(wx.EVT_BUTTON, self.import_mappings,
                  self.import_list_view.import_mapping)
        self.Bind(wx.EVT_BUTTON,self.export_mappings,self.import_list_view.export_mapping)
        self.Bind(wx.EVT_BUTTON, self.select_part, self.import_list_view.select_part_button)
